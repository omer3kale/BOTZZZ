...
class RevenueOptimizationEngine:
    ...
    def init_database(self):
        """Initialize database schema for revenue optimization"""
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS products (
                ...
                demand_elasticity REAL DEFAULT -1.0,
                competitor_prices TEXT, -- JSON
                pricing_strategy TEXT DEFAULT 'dynamic',
                last_price_change TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS price_tests (
                ...
                control_revenue REAL DEFAULT 0.0,
                variant_revenue REAL DEFAULT 0.0,
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS customer_segments (
                ...
                average_ltv REAL DEFAULT 0.0,
                average_mrr REAL DEFAULT 0.0,
                churn_rate REAL DEFAULT 0.0,
                upsell_rate REAL DEFAULT 0.0,
                pricing_sensitivity REAL DEFAULT 0.0,
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            )
        ''')
        
        # Revenue optimization campaigns table
        cursor.execute('''
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS competitor_analysis (
                ...
                features_comparison TEXT, -- JSON
                market_position TEXT,
                price_change_frequency TEXT,
